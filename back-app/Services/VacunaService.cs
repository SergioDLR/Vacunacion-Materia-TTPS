    ...
    public class VacunaService
    {
        public List<DosisDTO> ArmarListaDosisDTOHepatitisBHB()
        {
            ...
            try
            {
                ...
                ReglaDTO regla1 = new ReglaDTO(0, "Aplicar antes de las 12 horas del nacimiento", null, 0, 0.5, null, false, true);
                ...
                ReglaDTO regla2 = new ReglaDTO(0, "Aplicar desde los 11 años", null, 4015, 0, "0", false, true);
                ...
                ReglaDTO regla3 = new ReglaDTO(0, "Aplicar al mes de la primera dosis", null, 30, 180, "1", false, true);
                ...
                ReglaDTO regla4 = new ReglaDTO(0, "Aplicar a los 6 meses de la primera dosis", null, 180, 0, "1", false, true);
        ...
        public List<DosisDTO> ArmarListaDosisDTOBCG()
        {
            ...
            try
            {
                //Primera dosis en nacimiento
                List<ReglaDTO> listaReglas1 = new List<ReglaDTO>();
                ReglaDTO regla1 = new ReglaDTO(0, "Aplicar antes de salir de la maternidad", null, 0, 0, null, false, false);
                listaReglas1.Add(regla1);
        ...
        public List<DosisDTO> ArmarListaDosisDTORotavirus()
        {
            ...
            try
            {
                //Primera dosis
                List<ReglaDTO> listaReglas1 = new List<ReglaDTO>();
                ReglaDTO regla1 = new ReglaDTO(0, "Aplicar desde los 2 meses del nacimiento hasta las 14 semanas y 6 días", null, 60, 104, null, false, false);
                listaReglas1.Add(regla1);
                DosisDTO dosisDTO1 = new DosisDTO(0, 0, "Primera Dosis", listaReglas1);

                //Segunda dosis
                List<ReglaDTO> listaReglas2 = new List<ReglaDTO>();
                ReglaDTO regla2 = new ReglaDTO(0, "Aplicar desde los 4 meses del nacimiento hasta los 6 meses", null, 60, 120, "0", false, false);
                listaReglas2.Add(regla2);
