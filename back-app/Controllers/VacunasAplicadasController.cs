...
namespace VacunacionApi.Controllers
{
    ...
    public class VacunasAplicadasController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GenerarCsv")]
        public async Task<ActionResult<ResponseCargarVacunasDTO>> GenerarCsv(string emailOperadorNacional = null)
        {
            try
            {
                ResponseCargarVacunasDTO response;
                List<string> errores = new List<string>();
                ...
                if (errores.Count > 0)
                    response = new ResponseCargarVacunasDTO("Rechazada", true, errores, emailOperadorNacional);
                else
                {
                    ...
                    response = new ResponseCargarVacunasDTO("Aceptada", true, errores, emailOperadorNacional);
                }
        ...
        //[HttpGet]
        //[Route("Etl")]
        //public async Task<ActionResult<ResponseCargarVacunasDTO>> Etl(string emailOperadorNacional = null)
        //{
        //    try
        //    {
        //        ResponseCargarVacunasDTO response;
