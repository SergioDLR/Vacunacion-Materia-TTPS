...
{
    public class RequestMarcaComercialUpdateDTO
    {
        ...
        [Required(ErrorMessage = "El campo marca comercial nueva es requerido")]
        [StringLength(100, ErrorMessage = "El campo marca comercial nueva debe tener una longitud máxima de 100 caracteres")]
        public string DescripcionMarcaComercialNueva { get; set; }
    }
}
