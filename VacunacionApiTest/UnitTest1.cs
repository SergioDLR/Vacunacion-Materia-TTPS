...
namespace VacunacionApiTest
{
    public class UnitTest1 : ControllerBase
    {
        ...
        public UnitTest1()
        {
            ...
            //_listaUsuariosDTO = new ResponseListaUsuariosDTO();
        ...
        public async void Test1()
        {
            ...
            var result2 = await _usuariosController.GetAll("fabi@gmail.com", 1, 1);
            var estado = result2.Value.EstadoTransaccion;
            ...
            Assert.True(estado.Equals(true));   
